...
//Route::middleware('jwt.auth')->group(function () {
    ...
    // ============================================
    // REPORTES ESTADÍSTICAS PDF - ADMIN Y ENTRENADOR
    // ============================================
...
// ============================================
// ⚠️ RUTAS ESPECÍFICAS PRIMERO (antes de las genéricas)
Route::get('jugadores/mi-perfil', [JugadoresController::class, 'miPerfil'])->middleware('auth_administrador:3');
...
Route::delete('jugadores/{id}', [JugadoresController::class, 'destroy'])->middleware('auth_administrador:1,2');
   ...
   // ============================================
// RENDIMIENTOS PARTIDOS - Admin, Entrenador y Jugador
// ============================================
...
Route::get('rendimientospartidos/jugador/{idJugadores}/ultimos-partidos/{limit?}', [RendimientosPartidosController::class, 'getLastMatches'])->middleware('auth_administrador:1,2,3');
