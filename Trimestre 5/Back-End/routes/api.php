...
Route::middleware('jwt.auth')->group(function () {
    ...
    // ============================================
    // En routes/api.php - AGREGAR ANTES de Route::get('jugadores', ...)
    Route::get('jugadores/comparar', [JugadoresController::class, 'compararJugadores'])
...
Route::get('categorias/{id}/jugadores', [CategoriasController::class, 'jugadores'])
    ->middleware('auth_administrador:1,2');

// Ruta para obtener rendimientos de un jugador
Route::get('jugadores/{id}/rendimientos', [JugadoresController::class, 'rendimientos'])
    ->middleware('auth_administrador:1,2');


// ============================================
// CRONOGRAMAS -> Partidos relacionados
// ============================================
Route::get('cronogramas/{id}/partidos', [cronogramasController::class, 'partidos'])
    ->middleware('auth_administrador:1,2,3');
    // Ruta para comparar jugadores
Route::post('jugadores/comparar', [JugadoresController::class, 'compararJugadores'])
    ->middleware('auth_administrador:1,2');
    // Ruta para obtener jugadores por categoría
Route::get('categorias/{id}/jugadores', [CategoriasController::class, 'jugadores'])
    ->middleware('auth_administrador:1,2');