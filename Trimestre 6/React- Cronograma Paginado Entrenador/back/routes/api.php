...
// ============================================
// RUTAS SIN PROTECCIÓN (TEMPORAL - SOLO DESARROLLO)
// ============================================
...
// JUGADORES
Route::get('jugadores/misDatos', [JugadoresController::class, 'misDatos']);
Route::get('jugadores/mi-perfil', [JugadoresController::class, 'miPerfil']);
...
// RENDIMIENTOS PARTIDOS - RUTAS ESPECÍFICAS PRIMERO
...
// RENDIMIENTOS PARTIDOS - RUTAS GENÉRICAS
...
Route::get('categorias/{id}/jugadores', [CategoriasController::class, 'getJugadoresPorCategoria']);
