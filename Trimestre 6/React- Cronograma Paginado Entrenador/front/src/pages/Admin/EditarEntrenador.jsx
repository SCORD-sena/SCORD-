...
const EditarEntrenador = () => {
  ...
  return (
    <div>
      ...
      <title>Editar Entrenador - SCORD</title>
      <link
      ...
      <header className="header bg-white shadow-sm py-3">
        <nav className="navbar container d-flex align-items-center justify-content-between flex-wrap">
          <div className="d-flex align-items-center">
            ...
            " alt="Logo SCORD" className="me-2" style={{ height: "60px" }} />
      ...
      <main className="container my-5">
        <div className="text-center mb-4">
          <h1 className="text-danger">Editar Entrenador</h1>
        </div>

        <form onSubmit={editarEntrenador}>
          <div className="row">
            {/* Columna izquierda */}
