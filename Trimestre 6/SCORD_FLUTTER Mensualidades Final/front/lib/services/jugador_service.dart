...
class JugadorService {
  ...
  Future<Jugador> show(int idJugador) async {
    try {
      print('📡 Obteniendo jugador ID: $idJugador');
      ...
      if (response.statusCode == 200) {
        ...
        print('✅ Jugador obtenido con datos de mensualidad');
  ...
  Future<Jugador> registrarPagoMensualidad(int idJugador) async {
    try {
      print('💰 Registrando pago para jugador ID: $idJugador');
      ...
      print('❌ Error en registrarPagoMensualidad: $e');
      rethrow;
    }
  }
