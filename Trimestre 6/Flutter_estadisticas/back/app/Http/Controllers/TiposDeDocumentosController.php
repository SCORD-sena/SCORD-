...
class TiposDeDocumentosController extends Controller
{
    ...
    {
        $tiposdedocumentos = TiposDeDocumentos::all();
    ...
    public function store(Request $request)
    {
        ...
        $tiposdedocumentos = TiposDeDocumentos::create($request->all());
    ...
    {
        $tiposdedocumentos = TiposDeDocumentos::find($id);
    ...
    public function update(Request $request, $id)
    {
        ...
        $validator = Validator::make($request->all(), [
            'Descripcion' => 'sometimes|string|max:50|unique:tiposdedocumentos,Descripcion,' . $tiposdedocumentos->idTiposDeDocumentos,
        ]);
