...
import '../../controllers/entrenador/comparacion_jugadores_controller.dart';
import '../../models/categoria_model.dart';
import '../../models/jugador_model.dart'; // ✅ IMPORTAR EL MODELO
import '../../widgets/entrenador/comparar_jugadores/comparacion_chart_widget.dart';
import '../../widgets/entrenador/comparar_jugadores/comparacion_table_widget.dart';

class ComparacionJugadoresEntrenadorScreen extends StatefulWidget {
  const ComparacionJugadoresEntrenadorScreen({Key? key}) : super(key: key);

  @override
  State<ComparacionJugadoresEntrenadorScreen> createState() =>
      _ComparacionJugadoresScreenState();
}

class _ComparacionJugadoresScreenState
    extends State<ComparacionJugadoresEntrenadorScreen> {
