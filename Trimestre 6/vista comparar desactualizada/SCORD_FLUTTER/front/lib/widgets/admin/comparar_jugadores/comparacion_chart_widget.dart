...
class ComparacionChartWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, dynamic>> estadisticas = [
      {'key': 'goles', 'label': 'Goles', 'icon': '🏆', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
      {'key': 'goles_cabeza', 'label': 'Goles de Cabeza', 'icon': '⚽', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
      {'key': 'asistencias', 'label': 'Asistencias', 'icon': '👍', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
      {'key': 'tiros_puerta', 'label': 'Tiros a Puerta', 'icon': '🎯', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
      {'key': 'fueras_juego', 'label': 'Fueras de Juego', 'icon': '🚩', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
      {'key': 'partidos_jugados', 'label': 'Partidos Jugados', 'icon': '📅', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
      {'key': 'tarjetas_amarillas', 'label': 'Tarjetas Amarillas', 'icon': '🟨', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
      {'key': 'tarjetas_rojas', 'label': 'Tarjetas Rojas', 'icon': '🟥', 'color1': const Color(0xFF3B82F6), 'color2': const Color(0xFFEF4444)},
    ];
