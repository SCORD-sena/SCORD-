      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          columns: const [
            ...
            DataColumn(label: Text('Hora', style: TextStyle(fontWeight: FontWeight.bold))), // ← AGREGADO
          ...
          rows: controller.paginatedPartidos.isEmpty
              ...
              : controller.paginatedPartidos.map((p) {
                  ...
                  final categoria = controller.categoriasAPI.firstWhere(
                    ...
                    orElse: () => Categoria(idCategorias: 0, descripcion: 'N/A', tiposCategoria: ''),
                  );
                          ...
                          children: [
                            ...
                            Text(
                              cronograma.hora != null && cronograma.hora!.isNotEmpty
                                  ? cronograma.hora!.substring(0, 5) // Mostrar solo HH:MM
                                  : '-',
                            ),
                          ],
                        ),
                  ...
                  children: [
                    ...
                    _buildDropdownField<int?>(
                      ...
                      items: [
                        ...
                        ...controller.categoriasAPI.map((cat) => DropdownMenuItem<int?>(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          'No hay competencias creadas para esta categoría. Contacta al administrador.',
                                          style: TextStyle(
                    ...
                    // Hora
                    _buildTimeField(
                      controller: controller.horaPartidoController,
                      context: context,
