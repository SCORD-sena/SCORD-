...
class AdminDrawerMenu extends StatelessWidget {
    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          _buildDrawerItem('Categorías', Icons.category, '/GestionCategorias'),
          
          // ====== NUEVO: Menú desplegable de Historial ======
          const Divider(),
          ExpansionTile(
            leading: const Icon(Icons.history, color: Colors.red),
            title: const Text('Historial', style: TextStyle(fontSize: 16)),
            children: [
              _buildDrawerSubItem('Jugadores Eliminados', Icons.person_off, '/HistorialJugadores'),
  ...
  // ====== NUEVO: Widget para sub-items del menú desplegable ======
  Widget _buildDrawerSubItem(String title, IconData icon, String routeName) {
    return ListTile(
