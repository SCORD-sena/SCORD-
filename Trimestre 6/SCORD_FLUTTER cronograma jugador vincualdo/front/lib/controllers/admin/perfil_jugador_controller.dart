...
class PerfilJugadorController extends ChangeNotifier {
  ...
  try {
    final idEliminado = jugadorSeleccionado!.idJugadores;
    final categoriaActual = categoriaSeleccionada; // Guardar la categoría seleccionada
    
    // Eliminar en el backend (soft delete)
    await _jugadorService.deleteJugador(idEliminado);
    ...
    // Restaurar la categoría seleccionada y filtrar
