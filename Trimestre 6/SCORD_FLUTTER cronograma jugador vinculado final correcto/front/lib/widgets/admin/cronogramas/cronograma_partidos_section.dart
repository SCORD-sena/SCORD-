...
class CronogramaPartidosSection extends StatelessWidget {
      ...
      child: SingleChildScrollView(
        ...
        child: DataTable(
          ...
          columns: const [
            ...
            DataColumn(label: Text('Hora', style: TextStyle(fontWeight: FontWeight.bold))), // ← NUEVO
  ...
  // ← NUEVO: Widget para seleccionar Hora
