              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Selección de jugador (Widget reutilizable)
                    ...
                    // Información Personal (Widget reutilizable)
                    InfoPersonalCard(
                      modoEdicion: _controller.modoEdicion,
                      jugadorSeleccionado: _controller.jugadorSeleccionado,
                    ...
                    // Información de Contacto (Widget reutilizable)
                    InfoContactoCard(
                      modoEdicion: _controller.modoEdicion,
                      jugadorSeleccionado: _controller.jugadorSeleccionado,
                      controllers: _controller.controllers,
                    ...
                    // Información de Tutores (Widget reutilizable)
                    InfoTutoresCard(
                      modoEdicion: _controller.modoEdicion,
                      jugadorSeleccionado: _controller.jugadorSeleccionado,
                      controllers: _controller.controllers,
                    ...
                    // Información Deportiva (Widget reutilizable)
                    InfoDeportivaCard(
                      modoEdicion: _controller.modoEdicion,
                      jugadorSeleccionado: _controller.jugadorSeleccionado,
                      controllers: _controller.controllers,
