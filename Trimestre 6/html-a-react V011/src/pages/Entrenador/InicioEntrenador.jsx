...
<div>
  ...
  <main className="container my-5">
    ...
    <section className="text-center mb-5">
      <h1 className="mb-3">Bienvenido(a), <span className="text-danger">Andres Prada</span></h1>
        ...
        <div className="col-md-6">
          <ul className="list-group list-group-flush shadow-sm">
            <li className="list-group-item d-flex justify-content-between">
              <strong>Nombre:</strong> <span>Andres Prada</span>
            </li>
            <li className="list-group-item d-flex justify-content-between">
              <strong>Edad:</strong> <span>24</span>
            </li>
            <li className="list-group-item d-flex justify-content-between">
              <strong>Genero:</strong> <span>Masculino</span>
            </li>
            <li className="list-group-item d-flex justify-content-between">
              <strong>Entrenador Categoría:</strong> <span>2007</span>
            </li>
          </ul>
        </div>
      </div>
