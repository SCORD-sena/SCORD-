...
const PerfilEntrenadorAdmin = () => {
  ...
  return (
    <div>
      ...
      <main className="container my-4">
        {/* Botón de editar - ARRIBA DE TODO */}
        <div className="d-flex justify-content-center mb-4 gap-2">
          <Link to="/AgregarEntrenador" className="btn btn-success fw-bold">
            Agregar Entrenador
          </Link>
          <Link to="/EditarEntrenador" className="btn btn-warning fw-bold">
            Editar Entrenador
          </Link>
          <button className="btn btn-danger fw-bold" onClick={eliminarEntrenador}>Eliminar Entrenador</button>
        </div>
  ...
  <section className="card p-4 shadow-sm" style={{ width: "350px" }}>
    ...
    <div className="mb-3">
      ...
      <select className="form-select" id="categoriaSelect">
    ...
    <div className="mb-3">
      ...
      <select className="form-select" id="jugadorSelect">
        <option selected disabled>
        ...
        <div className="row g-5 mt-4">
          <div className="col-md-12">
            ...
            <ul className="list-group list-group-flush shadow-sm rounded-3">
              <li className="list-group-item d-flex justify-content-between">
                <strong>Nombres:</strong> <span>Brandon Stiven</span>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <strong>Apellidos:</strong> <span>Duque Tapia</span>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <strong>Edad:</strong> <span>19</span>
              </li>
              <li className="list-group-item d-flex justify-content-between">
                <strong>Fecha de Nacimiento:</strong> <span>11 Noviembre 2005</span>
              </li>
              <li className="list-group-item d-flex justify-content-between">
