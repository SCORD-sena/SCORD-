...
class _PerfilEntrenadorAdminScreenState
  ...
  Future<void> _cargarDatosIniciales() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        await CustomAlert.mostrar(context, 'Error', 'Error al cargar datos: $e', Colors.red);
      }
    }
  }
  ...
  Future<void> _guardarCambios() async {
    ...
    try {
      ...
      if (mounted) {
        ...
        await CustomAlert.mostrar(context, 'Error', 'Error al actualizar: $e', Colors.red);
      }
    }
  }
  ...
  try {
    final categoriaActual = _categoriaSeleccionada; // ← NUEVO: Guardar categoría
    ...
    if (mounted) {
      ...
      // ← NUEVO: Restaurar categoría y filtrar
      if (categoriaActual != null) {
        setState(() => _categoriaSeleccionada = categoriaActual);
        _filtrarEntrenadores();
      }
    }
  } catch (e) {
...
Widget build(BuildContext context) {
  ...
  return Scaffold(
    ...
    drawer: AdminDrawer(currentRoute: '/PerfilEntrenadorAdmin'),
