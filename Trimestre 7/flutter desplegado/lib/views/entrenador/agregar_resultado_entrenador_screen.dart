...
import '../../widgets/entrenador/resultados/formulario_datos_resultado_entrenador.dart';
import '../../widgets/common/custom_alert.dart';

class AgregarResultadoEntrenadorScreen extends StatefulWidget {
  const AgregarResultadoEntrenadorScreen({super.key});

  @override
  State<AgregarResultadoEntrenadorScreen> createState() => _AgregarResultadoEntrenadorScreenState();
}

class _AgregarResultadoEntrenadorScreenState extends State<AgregarResultadoEntrenadorScreen> {
  late AgregarResultadoEntrenadorController _controller;

  @override
  void initState() {
    super.initState();
    _controller = AgregarResultadoEntrenadorController();
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            FormularioDatosResultadoEntrenador(controller: _controller),
