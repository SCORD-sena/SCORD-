...
class DialogoResultadoEntrenador extends StatefulWidget {
  final GestionResultadosEntrenadorController controller;

  const DialogoResultadoEntrenador({
    super.key,
    required this.controller,
  });

  @override
  State<DialogoResultadoEntrenador> createState() => _DialogoResultadoEntrenadorState();
}

class _DialogoResultadoEntrenadorState extends State<DialogoResultadoEntrenador> {
  @override
