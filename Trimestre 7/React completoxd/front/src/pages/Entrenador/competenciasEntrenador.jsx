...
const CompetenciasEntrenador = () => {
  ...
  const validarFormulario = () => {
    ...
    } else if (isNaN(selectedCompetencia.Ano) || selectedCompetencia.Ano < 1900 || selectedCompetencia.Ano > 2100) {
  ...
  // ✅ FIX 1 - SONARQUBE: Ternarios anidados extraídos a función independiente
    ...
    return (
      <>
              ...
              {competencias.map((competencia) => (
                <tr key={competencia.idCompetencias}>
                  ...
                  <td className="text-center">
                    {/* ✅ FIX 2 - SONARQUBE: role="group" reemplazado por fieldset */}
                    <fieldset className="btn-group">
                      ...
                      <button
                        ...
                        onClick={() => abrirModal("editar", competencia)}
                        title="Editar"
                      >
                      ...
                      <button
                        ...
                        onClick={() => handleEliminar(competencia.idCompetencias)}
                        title="Eliminar"
                      >
        ...
        <div className="d-flex justify-content-between align-items-center mt-3">
          <div>
            Mostrando {competencias.length} de {totalItems} competencias
          </div>
          <nav>
            <ul className="pagination mb-0">
              ...
              {/* ✅ FIX 3 - SONARQUBE: Array() reemplazado por new Array() */}
  ...
  // ✅ FIX SONARQUBE: Ternarios del título del modal extraídos a función
  ...
  return (
    <div className="container-fluid py-4">
        ...
        <div className="card-body">
          <div className="row g-3">
            ...
            <div className="col-md-2">
              <label htmlFor="inputAño" className="form-label">Año</label>
              <select
                className="form-select"
                name="ano"
                value={filtros.ano}
      ...
      <div className="card shadow-sm">
        <div className="card-body">
          {/* ✅ FIX: Ternarios anidados reemplazados por función */}
          {renderContenido()}
        </div>
      </div>
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              <div className="modal-header bg-danger text-white">
                {/* ✅ FIX: Título del modal extraído a función */}
...
export default CompetenciasEntrenador;