...
import CompetenciasEntrenador from "./pages/Entrenador/competenciasEntrenador";
//Jugador
...
import CompetenciaJugador from "./pages/Jugador/CompetenciaJugador";
//Otros
...
function App() {
  return (
      ...
      <Routes>
        ...
        <Route path="/CompetenciasAdmin" element={<CompetenciasAdmin/>}/>
        <Route path="/ResultadosAdmin" element={<ResultadosAdmin/>}/>
        <Route path="/HistorialAdmin" element={<HistorialPage />} />
        ...
        <Route path="/CompetenciasEntrenador" element={<CompetenciasEntrenador/>} />
        ...
        <Route path="/CompetenciaJugador" element={<CompetenciaJugador/>} />
