...
const CompetenciasEntrenador = () => {
  ...
  // Cargar competencias cuando cambien los filtros o la página
  useEffect(() => {
    cargarCompetencias();
  }, [filtros, currentPage]);
            ...
            <div className="modal-content">
              <div className="modal-header bg-danger text-white">
                <h5 className="modal-title">
                  {modalMode === "crear" && "Nueva Competencia"}
                  {modalMode === "editar" && "Editar Competencia"}
                  {modalMode === "ver" && "Detalles de Competencia"}
                </h5>
                <button
                  type="button"
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      maxLength={30}
                    />
                    {errors.TipoCompetencia && (
                      <div className="invalid-feedback">{errors.TipoCompetencia}</div>
                    )}
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    />
                    {errors.Ano && (
                      <div className="invalid-feedback">{errors.Ano}</div>
                    )}
                  </div>
                  ...
                  <div className="mb-3">
                    ...
                    {errors.idEquipos && (
                      <div className="invalid-feedback">{errors.idEquipos}</div>
                    )}
                  </div>
