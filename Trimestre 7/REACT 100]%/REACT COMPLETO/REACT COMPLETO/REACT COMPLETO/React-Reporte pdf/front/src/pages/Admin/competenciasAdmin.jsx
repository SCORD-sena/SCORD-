...
const CompetenciasAdmin = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const idCategorias = parseInt(selectedCompetencia.idCategorias);
      const ano = parseInt(selectedCompetencia.Ano);
      ...
      console.log("Tipo de Ano:", typeof datosEnviar.Ano);
      console.log("Tipo de idCategorias:", typeof datosEnviar.idCategorias);
      ...
      <div className="card shadow-sm">
        <div className="card-body">
          {loading ? (
            ...
            <div className="alert alert-info text-center">No hay competencias registradas</div>
          ) : (
            <>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {modalMode !== "ver" && (
                    <div className="d-flex justify-content-end gap-2">
                      ...
                      <button type="submit" className="btn btn-danger">{modalMode === "crear" ? "Crear" : "Guardar Cambios"}</button>
                    </div>
                  )}
