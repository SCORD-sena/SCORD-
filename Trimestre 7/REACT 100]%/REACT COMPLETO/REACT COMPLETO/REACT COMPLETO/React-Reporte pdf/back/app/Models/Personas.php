...
use Illuminate\Database\Eloquent\SoftDeletes; // ← NUEVO: Importar SoftDeletes
...
{
    use HasFactory, Notifiable, SoftDeletes; // ← NUEVO: Agregar SoftDeletes
    ...
    */
    ...
    public function getJWTCustomClaims()
    {
        ...
        $this->loadMissing(['tiposDeDocumentos', 'rol']);

        return [
            'documento' => $this->NumeroDeDocumento,
            'nombre_completo' => trim($this->Nombre1 . ' ' . $this->Nombre2 . ' ' . $this->Apellido1 . ' ' . $this->Apellido2),
            'nombre' => $this->Nombre1,
