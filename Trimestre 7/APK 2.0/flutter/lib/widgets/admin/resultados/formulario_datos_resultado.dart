...
class FormularioDatosResultado extends StatefulWidget {
  final AgregarResultadoController controller;

  const FormularioDatosResultado({
    super.key,
    required this.controller,
  });

  @override
  State<FormularioDatosResultado> createState() => _FormularioDatosResultadoState();
}

class _FormularioDatosResultadoState extends State<FormularioDatosResultado> {
  @override
