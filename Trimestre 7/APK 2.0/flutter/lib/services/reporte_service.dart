    ...
    try {   
      ...
      if (config.tipo == TipoReportePdf.general) {
        ...
        if (config.idCompetencia == null) {
          throw Exception('Se requiere un ID de competencia');
        }
      ...
      final response = await http.get(url, headers: headers)
          .timeout(
            ...
            onTimeout: () => throw Exception('El servidor tardó demasiado. Intenta de nuevo.'),
          );
      ...
      if (response.statusCode == 200) {
        ...
        // Usar directorio de documentos de la app (no requiere permisos especiales)
        ...
        if (response.statusCode == 404) {
          ...
          throw Exception('Error en el servidor al generar el PDF');
        } else {
