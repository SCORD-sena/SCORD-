        ...
        child: DataTable(
          ...
          rows: controller.paginatedPartidos.isEmpty
              ...
              : controller.paginatedPartidos.map((p) {
                  ...
                  if (cronograma == null) {
                    return DataRow(cells: List.generate(7, (index) => const DataCell(Text('Error'))));
                  }

                  // ← OBTENER COMPETENCIA REAL
                  final competencia = controller.getCompetenciaById(cronograma.idCompetencias);
                  final nombreCompetencia = competencia?.nombre ?? 'Sin competencia';
