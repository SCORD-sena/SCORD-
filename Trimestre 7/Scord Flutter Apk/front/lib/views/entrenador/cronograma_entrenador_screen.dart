...
class _CronogramaEntrenadorScreenState extends State<CronogramaEntrenadorScreen> {
  ...
  Future<void> _handleEditarPartido(int idPartido) async {
    ...
    await _controller.editarPartido(partido);
  ...
  // ✅ HANDLER - Editar Entrenamiento (async)
  Future<void> _handleEditarEntrenamiento(int idCronograma) async {
    ...
    await _controller.editarEntrenamiento(cronograma);
  ...
  // ✅ HANDLER - Categoría Entrenamiento (optimizado)
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      drawer: EntrenadorDrawer(currentRoute: '/CronogramaEntrenador'), // ✅ NUEVO
