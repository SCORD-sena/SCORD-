...
import '../../controllers/entrenador/gestion_resultados_entrenador_controller.dart';
import '../../models/resultado_model.dart';
import '../../widgets/admin/resultados/filtros_resultados.dart';
import '../../widgets/entrenador/resultados/dialogo_resultado_entrenador.dart';
import '../../widgets/admin/resultados/tabla_resultados.dart';
import '../../widgets/common/custom_alert.dart';
import '../../widgets/common/EntrenadorDrawer.dart';

class GestionResultadosEntrenadorScreen extends StatefulWidget {
  const GestionResultadosEntrenadorScreen({super.key});

  @override
  State<GestionResultadosEntrenadorScreen> createState() => _GestionResultadosEntrenadorScreenState();
}

class _GestionResultadosEntrenadorScreenState extends State<GestionResultadosEntrenadorScreen> {
  late GestionResultadosEntrenadorController _controller;

  @override
  void initState() {
    super.initState();
    _controller = GestionResultadosEntrenadorController();
  ...
  Future<void> _handleNuevoResultado() async {
    ...
    final resultado = await Navigator.of(context).pushNamed('/AgregarResultadoEntrenador');
  ...
  Future<void> _handleEditarResultado(Resultado resultado) async {
    ...
    final res = await showDialog<bool>(
      context: context,
      builder: (context) => DialogoResultadoEntrenador(controller: _controller),
    );
...
Widget build(BuildContext context) {
  return Scaffold(
    ...
    drawer: EntrenadorDrawer(currentRoute: '/GestionResultadosEntrenador'), // ✅ NUEVO
