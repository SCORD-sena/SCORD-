...
<body>
    ...
    {{-- 🤖 SECCIÓN DE ANÁLISIS POR IA --}}
@if(isset($analisisIA) && !empty($analisisIA))
<div class="seccion" style="page-break-before: auto;">
    <div class="seccion-titulo" style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); border-left: 6px solid #5a67d8;">
        <span style="font-size: 14pt;">🤖</span> Análisis Técnico Generado por Inteligencia Artificial
    </div>
    
    <div style="padding: 20px; background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); border-left: 4px solid #667eea; line-height: 1.8; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <div style="white-space: pre-wrap; font-size: 10.5pt; color: #2d3748;">
            {!! nl2br(e($analisisIA)) !!}
        </div>
    </div>
    
    <p class="nota-pie" style="font-size: 8pt; color: #718096; margin-top: 15px; padding: 10px; background: #edf2f7; border-radius: 4px; border-left: 3px solid #a0aec0;">
        <strong>⚠️ Nota importante:</strong> Este análisis ha sido generado automáticamente mediante Inteligencia Artificial basándose en las estadísticas del jugador. 
        Debe ser considerado como una herramienta de apoyo y complementarse con la evaluación directa del cuerpo técnico y observación en campo.
    </p>
</div>
@endif
    {{-- 🤖 FIN SECCIÓN DE ANÁLISIS POR IA --}}
