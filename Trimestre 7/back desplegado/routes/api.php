...
// ============================================
Route::post('/competencias/with-categoria', [CompetenciasController::class, 'storeWithCategoria'])->middleware('auth_administrador:1,2'); // ⭐ AGREGAR MIDDLEWARE

Route::get('competencias', [CompetenciasController::class, 'index'])->middleware('auth_administrador:1,2');
Route::get('competencias/papelera/listar', [CompetenciasController::class, 'trashed'])->middleware('auth_administrador');
...
Route::post('competencias/{id}/restaurar', [CompetenciasController::class, 'restore'])->middleware('auth_administrador');
...
// ============================================
    ...
    // ============================================
    Route::get('resultados/trashed', [ResultadosController::class, 'getTrashed'])->middleware('auth_administrador:1,2');
    Route::get('resultados', [ResultadosController::class, 'index'])->middleware('auth_administrador:1,2,3');
    Route::get('resultados/papelera/listar', [ResultadosController::class, 'trashed'])->middleware('auth_administrador:1,2'); // NUEVO
    Route::get('resultados/{id}', [ResultadosController::class, 'show'])->middleware('auth_administrador:1,2,3');
...
Route::get('rendimientospartidos/trashed', [RendimientosPartidosController::class, 'getTrashed'])->middleware('auth_administrador:1,2'); // ← MOVIDA AQUÍ
Route::get('rendimientospartidos/papelera/listar', [RendimientosPartidosController::class, 'trashed'])->middleware('auth_administrador:1,2');
...
// ✅ RUTAS GENÉRICAS DESPUÉS (con parámetros dinámicos como {id})
...
Route::post('rendimientospartidos/{id}/restaurar', [RendimientosPartidosController::class, 'restore'])->middleware('auth_administrador:1,2');
Route::delete('rendimientospartidos/{id}/forzar', [RendimientosPartidosController::class, 'forceDelete'])->middleware('auth_administrador:1,2');
