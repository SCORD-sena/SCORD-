...
class FormularioSeleccionResultado extends StatelessWidget {
  ...
  const FormularioSeleccionResultado({
    super.key,
            ...
            if (isLoadingCompetencias)
              ...
              Column(
                ...
                children: [
                  ...
                  if (categoriaSeleccionada != null && competenciasFiltradas.isEmpty)
                    Padding(
