...
Future<void> iniciarSesion() async {
  ...
  try {
    ...
    if (data["success"] == true) {
      ...
      // Mostrar token FCM temporalmente
...
if (mounted) {
  showDialog(
    ...
    builder: (context) => AlertDialog(
      ...
      content: SelectableText(token ?? "No hay token"),
      actions: [
        TextButton(
      ...
      switch (rol) {
        case 1:
          await Navigator.pushReplacementNamed(context, "/InicioAdmin");
          break;
        case 2:
          await Navigator.pushReplacementNamed(context, "/InicioEntrenador");
          break;
        case 3:
          await Navigator.pushReplacementNamed(context, "/InicioJugador");
          break;
        default:
